...
public class CRUDControllerRefined {
    ...
    //declare the class
    //private final ItemServiceAnalysis analysisService;
    
    //add the constructor item services
   // public CRUDControllerRefined(ItemService itemService,ItemServiceAnalysis analysisService) {
    ...
    //mapping with ItemServiceAnalysis
    @GetMapping("/getDemo")
    public ResponseEntity<List<Item>> getAllItemsWithDemo() {
        return ResponseEntity.ok(itemService.getAllItemsWithDemo());
    }
